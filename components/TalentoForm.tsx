...
export default function TalentoForm() {
  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    } catch { setStatus("No se pudo enviar la postulación. Inténtalo más tarde."); }
